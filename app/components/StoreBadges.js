...
function Badge({ icon, label, sub }) {
  return (
    <div
      ...
      style={{
        border: '1px solid rgba(93,186,232,0.25)',
        background: 'linear-gradient(180deg, rgba(93,186,232,0.05), rgba(93,186,232,0.02))',
      }}
    >
      <span className="opacity-80 text-[#5DBAE8]">{icon}</span>
