...
function Badge({ icon, label, sub }) {
  return (
    <div
      ...
      style={{
        border: '1px solid rgba(108,130,184,0.25)',
        background: 'linear-gradient(180deg, rgba(108,130,184,0.05), rgba(108,130,184,0.02))',
      }}
    >
      <span className="opacity-80 text-[#6C82B8]">{icon}</span>
