...
const FloatingLogo = ({ active = true, anchor, size = 72 }) => {
  ...
  return (
    <button
      ...
      className="fixed z-50 cursor-pointer text-[#D4AF37] transition-[filter] duration-300 hover:[filter:drop-shadow(0_0_28px_rgba(212,175,55,0.7))] focus:outline-none focus-visible:ring-2 focus-visible:ring-primary rounded-full"
      style={{
        left: 0,
        top: 0,
        width: size,
