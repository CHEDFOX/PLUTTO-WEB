    ...
    <>
      ...
      <div className="relative z-10">
        ...
        <section className="mx-auto max-w-7xl px-6 pt-16 md:pt-24 pb-24">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 items-center">
            <div className="md:col-span-6 order-2 md:order-1">
              <FadeUp>
                <p
                  className="uppercase text-[#4EC5F2]"
                  style={{
              ...
              <FadeUp delay={0.4}>
                <div className="mt-10 flex items-center gap-5">
                  <Link
                    href="/about"
                    className="cta-glow inline-flex items-center justify-center rounded-md bg-[#4EC5F2] px-7 py-4 text-[#0A0A0A] font-body font-semibold uppercase"
        ...
        <section id="corpus" className="mx-auto max-w-7xl px-6 py-24">
          <FadeUp>
            <p
              className="uppercase text-[#4EC5F2] text-center"
              style={{
                fontFamily: "'JetBrains Mono', ui-monospace, monospace",
                fontSize: '0.7rem',
...
function FoundationCard({ eyebrow, title, body }) {
  return (
    <div
      ...
      style={{
        background: 'linear-gradient(180deg, rgba(78,197,242,0.03), rgba(255,255,255,0))',
        border: '1px solid rgba(78,197,242,0.10)',
      }}
    >
      <p
        className="uppercase text-[#4EC5F2]"
